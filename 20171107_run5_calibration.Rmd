...
df.raw <- raw_data %>% 
  ...
  filter(category %in% c("Background", "Degassed", "N2O", "Conditioner", "OM17", "soil", "USGS34", "IAEA-NO3", "USGS40", "USGS65", "oxidationblank")) 
...
```{r "remove problematic data points"}
 df.raw <- df.raw %>% 
 change_category(run_number %in% c(25, 24, 26, 27), "excluded") #  27 is too large; 24, 25, 26 too small 
